    ...
    <section id="contato" className="pb-1">
      ...
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="relative w-full">
          ...
          <div className="absolute inset-0 flex flex-col justify-end items-start pl-28 pb-20 translate-y-8">
            ...
            <div className="flex items-center gap-6 mb-6">
              ...
              <a
                ...
                className="px-4 py-3 mt-2 rounded-lg font-semibold bg-[#cd2e53] text-white hover:bg-white hover:text-[#cd2e53] transition whitespace-nowrap translate-y-8"
              >
                Falar no WhatsApp
              </a>
